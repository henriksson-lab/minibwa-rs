...
#[cfg(feature = "stage-time")]
pub use imp::{accumulate_global, enabled, flush_local, init_from_env, measure, report};

#[cfg(not(feature = "stage-time"))]
pub fn init_from_env() {}
...
#[cfg(not(feature = "stage-time"))]
#[inline(always)]
pub fn measure<R>(_b: Bucket, f: impl FnOnce() -> R) -> R {
    f()
}
...
#[cfg(not(feature = "stage-time"))]
#[inline]
pub fn accumulate_global(_b: Bucket, _ns: u64) {}
